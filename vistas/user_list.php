<div class="bodis">
  ...
  <?php
       ...
       /*  if(isset($_GET['user_id_del'])){
        ...
        /*definimos el numaero de pagina. Si no la hay, creamos la pagina nº1 */
        if(!isset($_GET['page'])){
            $pagina=1;
        }else{
            /* convertimos la variable a tipo entero */
            $pagina=(int) $_GET['page'];
            if($pagina<=1){ /*Si no la hay, creamos la pagina nº1  */
                $pagina=1;
            }
        }
        ...
        $registros=15; /*aqui manejamos el numero de registro de usuarios por pagina */
